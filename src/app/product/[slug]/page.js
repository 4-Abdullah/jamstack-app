...
// export async function product(context) {
//       console.log(context.query)
//       let headers = {Authorization: `Bearer ${process.env.ADMIN_TOKEN}`}
//       let a = await fetch(process.env.NEXT_PUBLIC_STRAPI_URL + "/api/product/" + context.query.slug + "&populate=*", {headers:headers})
    ...
    const Products = () => {
      ...
      return (
        <div className='container mx-auto px-4'>
          {/* Render your products using the 'products' state */}
...
//       <Image alt="ecommerce" className=" rounded" src={product}/>
//       </div>
